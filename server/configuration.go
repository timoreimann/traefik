...
type GlobalConfiguration struct {
	ReqTermGraceTimeOut       flaeg.Duration          `description:"Duration to keep accepting connections before Traefik initiates the graceful shutdown procedure"`
...
func NewTraefikConfiguration() *TraefikConfiguration {
	return &TraefikConfiguration{
		GlobalConfiguration: GlobalConfiguration{
			ReqTermGraceTimeOut:       flaeg.Duration(0 * time.Second),
